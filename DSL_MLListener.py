...
class DSL_MLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by DSL_MLParser#arithmeticOperation.
    def enterArithmeticOperation(self, ctx:DSL_MLParser.ArithmeticOperationContext):
        pass

    # Exit a parse tree produced by DSL_MLParser#arithmeticOperation.
    def exitArithmeticOperation(self, ctx:DSL_MLParser.ArithmeticOperationContext):
        pass
